...
class _PoultryKnowledgePageState extends State<PoultryKnowledgePage> {
  ...
  Widget _housing()=>ListView(padding:const EdgeInsets.all(12),children:[
    ...
    _infoCard(Icons.square_foot,t('Nafasi','Space'),t('Miongozo uliopakia inaonyesha nafasi hutegemea umri na mfumo. Mfano: vifaranga 16 kwa m² hadi takriban wiki 4; kuku wakubwa wa asili karibu 4–8 kwa m² kutegemea mfumo.','Poultry guides show stocking density depends on age/system. Example: about 16 chicks/m² to ~4 weeks; mature indigenous birds roughly 4–8/m² depending on system.')),
